class X8664ElfGrub < Formula
  ...
  resource "unifont" do
    ...
    mirror "https://mirrors.ocf.berkeley.edu/gnu/unifont/unifont-16.0.02/unifont-16.0.02.pcf.gz", using: :nounzip
  ...
  def install
    ...
    unifont_dir = buildpath/"unifont"
    unifont_dir.mkpath
    resource("unifont").stage do
      cp "unifont-16.0.02.pcf.gz", unifont_dir
    end
    ENV["UNIFONT"] = "#{unifont_dir}/unifont-16.0.02.pcf.gz"
